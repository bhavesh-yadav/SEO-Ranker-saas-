...
export async function rankTracker (keyword, targetDomain ){
  let browser;
  try {
    //Initialize Browserbase session & connect playwright
    ...
    timeout: 30000,})
      ...
      // 5. Result synthesis: update global results and check gor target match
  ...
  console.error("Ramk check error:",error.message);
